  ...
  const sections = [
    {
      title: 'Help',
      links: [
        { label: 'Contacto', path: 'https://wa.me/5491112345678', external: true },
        { label: 'Cambios y Devoluciones', path: '/cambios-y-devoluciones' },
      ]
    },
    {
      title: 'Shop',
      links: [
        { label: 'Hombre', path: '/shop' },
        { label: 'Mujer', path: '/shop' },
        { label: 'Nuevos Ingresos', path: '/shop' },
        { label: 'Promociones', path: '/shop' },
      ]
    },
    {
      title: 'Legal',
      links: [
        ...
        { label: 'Defensa del Consumidor', path: '/cambios-y-devoluciones' },
      ]
    }
  ]
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-16 lg:gap-12 mb-24">
          ...
          <div className="col-span-2 md:col-span-5 pr-10">
            <h2 className="mb-6 flex items-center gap-3">
              <img src={logoImg} alt="Tuviejasneakers Logo" className="h-10 object-contain invert" />
            </h2>
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/tuviejasneakers_/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 border border-white/20 rounded-full flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:border-transparent transition-all duration-300 transform hover:scale-110">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@tuvieja.sneakers" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-11 h-11 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-black hover:border-white transition-all duration-300 transform hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Whatsapp */}
              <a href="https://wa.me/5491112345678" target="_blank" rel="noopener noreferrer" className="w-11 h-11 border border-white/20 rounded-full flex items-center justify-center hover:bg-[#25D366] hover:border-[#25D366] transition-all duration-300 transform hover:scale-110">
                ...
                {section.links.map(l => (
                  <li key={l.label}>
                    {'external' in l && l.external ? (
                      ...
                      <Link to={l.path} className="text-[13px] text-gray-400 font-medium hover:text-white transition-colors">
                        {l.label}
                      </Link>
                    )}
                  </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <p className="text-[11px] text-gray-500 font-medium tracking-wide">
            © {new Date().getFullYear()} Tuviejasneakers Inc. All rights reserved.
          </p>
          
          <div className="flex items-center gap-4">
            <span className="text-[9px] font-bold tracking-[0.2em] text-gray-600 uppercase">Pagos</span>
            <div className="flex flex-wrap gap-2">
              <div className="px-3 py-1.5 border border-white/20 text-gray-400 text-[10px] font-bold tracking-widest uppercase transition-all duration-300 hover:bg-white hover:text-black hover:border-white cursor-default">Aceptamos todas las billeteras virtuales</div>
            </div>
          </div>
        </div>
