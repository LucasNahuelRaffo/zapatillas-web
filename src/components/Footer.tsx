        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-16 lg:gap-12 mb-24">
          ...
          <div className="col-span-2 md:col-span-5 pr-10">
            ...
            <div className="flex gap-4">
              ...
              {/* TikTok */}
              <a href="#" aria-label="TikTok" className="w-11 h-11 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-black hover:border-white transition-all duration-300 transform hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
